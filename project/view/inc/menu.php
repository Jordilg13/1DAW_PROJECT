<div id="menu">
	...
	<a href="index.php?page=controller_products&op=list" data-tr="Products">Products</a>&nbsp;&nbsp;|&nbsp;&nbsp;
    <a href="index.php?page=services" data-tr="Services">Services</a>&nbsp;&nbsp;|&nbsp;&nbsp;
	<a href="index.php?page=jqdatatable&op=list" data-tr="JQDatatable">JQDatatable</a>&nbsp;&nbsp;|&nbsp;&nbsp;
