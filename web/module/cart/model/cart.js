...
function append_products(data2,cant) {
    ...
    $('.cart-body')[0].lastChild.children[0].children[0].children[0].addEventListener("click", function () {
        window.location.href = "index.php?page=shop_controller&op=view_product&id=" + this.parentNode.parentNode.parentNode.id;
    });
    ...
    $('.cart-body')[0].lastChild.children[0].children[0].children[1].children[0].addEventListener("click", function () {
        window.location.href = "index.php?page=shop_controller&op=view_product&id=" + this.parentNode.parentNode.parentNode.parentNode.id;
    });
...
$(document).ready(function () {
    ...
    if (cart_op == "view_product" && cart_page == "shop_controller") {
    ...
    if (cart_op == "list" && cart_page == "shop_controller") {
        // when cart btn is clicked
        $('.cart-btn').on("click", function () {
    ...
    if (cart_page == null || cart_page == "shop_controller" && cart_op != "view_product") {
