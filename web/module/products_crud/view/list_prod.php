<div id="contenido">
    <div class="container">
    	...
    	<div class="row">
            <p><a href="index.php?page=controller_products&op=create" class="btn btn-success">Create</a>
            <!-- <button type="button" class="btn btn-success">Create</button> -->
            <a href="index.php?page=controller_products&op=deleteall" class="btn btn-danger">Delete All</a>
            <!-- <a href="index.php?page=controller_products&op=dummies" class="btn btn-info dummies_btn">Dummies</a></p> -->
                    ...
                    if ($rdo->num_rows === 0){
                        ...
                        foreach ($rdo as $row) {
                            ...
                            echo '<a class="btn btn-primary prod" id='.$row['product_code'].'>Modal</a>';
                    	   	...
                    	   	echo '<a class="btn btn-primary" href="index.php?page=controller_products&op=read&id='.$row['product_code'].'">Read</a>';
                    	   	echo '&nbsp;';
                    	   	echo '<a class="btn btn-success" href="index.php?page=controller_products&op=update&id='.$row['product_code'].'">Update</a>';
                    	   	echo '&nbsp;';
                            echo '<a class="btn btn-danger" href="index.php?page=controller_products&op=delete&id='.$row['product_code'].'">Delete</a>';
                            echo '&nbsp;';
