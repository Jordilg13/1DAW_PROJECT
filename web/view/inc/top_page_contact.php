...
<!-- //template -->
    ...
    <script type="text/javascript" src="module/home/model/main_products.js?jsVersion=<? echo _JS_VERSION_ ?>"></script>
    <script type="text/javascript" src="view/js/lang.js?jsVersion=<? echo _JS_VERSION_ ?>"></script>
	<script type="text/javascript" src="view/js/main.js?jsVersion=<? echo _JS_VERSION_ ?>"></script>
