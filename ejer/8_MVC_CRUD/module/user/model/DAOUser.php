<?php
	...
	class DAOUser{
		...
		function select_all_user(){
			$sql = "SELECT * FROM users_ejer8 ORDER BY user ASC";
		...
		function select_user($user){
			$sql = "SELECT * FROM users_ejer8 WHERE user='$user'";
		...
		function update_user($datos){
        	...
        	$sql = " UPDATE users_ejer8 SET pass='$passwd', name='$name', dni='$dni', sex='$sex', birthdate='$birthdate', age='$age',"
		...
		function delete_user($user){
			$sql = "DELETE FROM users_ejer8 WHERE user='$user'";
