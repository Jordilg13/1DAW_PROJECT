...
<body>
	<header><div class="w3-container w3-black"><h1>BIENVENIDO A ECODEUP</h1></div></header>
			<div class="w3-container w3-green"><h1>Registrarse</h1></div>
			<div>
	...
	<footer><div class="w3-container w3-black"><h4>ECODEUP</h4></div></footer>
</body>
</html>